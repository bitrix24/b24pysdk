...
def validate_event_app_info_request(
    ...
    *,
    ...
    This helper requires a non-system event payload with OAuth token data.
    """
    ...
    try:
        bitrix_token = BitrixToken.from_oauth_event_data(oauth_event_data=request.oauth_event_data, bitrix_app=bitrix_app)
...
@overload
def event_required(view_func: _FT, /) -> _FT: ...
