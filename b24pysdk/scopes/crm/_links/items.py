...
from ....schemas.crm.links import CompanyLink, CompanyLinksData, ContactLink, ContactLinksData
...
class Items(BaseCRM):
    ...
    def get(
            ...
            *,
            timeout: Timeout = None,
    ) -> BitrixAPIValuesRequest[Union[CompanyLinksData, ContactLinksData], Union[CompanyLink, ContactLink]]:
        ...
        return self._make_bitrix_api_request(
            ...
            result_adapter=BitrixSchemasAdapter(CompanyLink if self._context._name == "company" else ContactLink),
        )
