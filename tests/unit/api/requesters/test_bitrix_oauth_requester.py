...
def test_parse_response_converts_api_invalid_request_to_insufficient_scope():
    obj = create_requester()
    ...
    with patch("b24pysdk.api.requesters.bitrix_oauth_requester.BaseRequester._parse_response") as mock_base_parse:
...
def test_get_oauth_token_success(mock_get):
    ...
    with patch("b24pysdk.api.requesters.bitrix_oauth_requester.BitrixOAuthRequester._parse_response") as mock_parse:
