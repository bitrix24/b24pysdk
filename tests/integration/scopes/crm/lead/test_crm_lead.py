...
def test_crm_lead_fields(bitrix_client: BaseClient):
...
def test_crm_lead_add(bitrix_client: BaseClient, cache: Cache):
    ...
    lead_id = bitrix_response.result
...
def test_crm_lead_get(bitrix_client: BaseClient, cache: Cache):
...
def test_crm_lead_list(bitrix_client: BaseClient, cache: Cache):
...
def test_crm_lead_list_as_list(bitrix_client: BaseClient):
    """"""
...
def test_crm_lead_list_as_list_fast(bitrix_client: BaseClient):
    """"""
...
def test_crm_lead_update(bitrix_client: BaseClient, cache: Cache):
...
def test_crm_lead_delete(bitrix_client: BaseClient, cache: Cache):
