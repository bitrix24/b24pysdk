...
@pytest.mark.dependency(name="test_crm_lead_userfield_list", depends=["test_crm_lead_userfield_update"])
...
@pytest.mark.dependency(name="test_crm_lead_userfield_list_as_list", depends=["test_crm_lead_userfield_update"])
...
@pytest.mark.dependency(name="test_crm_lead_userfield_list_as_list_fast", depends=["test_crm_lead_userfield_update"])
