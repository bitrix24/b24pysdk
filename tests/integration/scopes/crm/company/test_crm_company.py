...
_FIELDS: Tuple[Text, ...] = (
    "ID", "TITLE", "COMPANY_TYPE", "INDUSTRY", "EMPLOYEES", "CURRENCY_ID", "REVENUE", "OPENED", "ASSIGNED_BY_ID", "PHONE", "EMAIL", "DATE_CREATE", "DATE_MODIFY", "CREATED_BY_ID",
    "MODIFY_BY_ID", "ADDRESS", "ADDRESS_CITY", "ADDRESS_COUNTRY", "ADDRESS_POSTAL_CODE", "BANKING_DETAILS", "COMMENTS", "HAS_EMAIL", "HAS_PHONE", "IM", "IS_MY_COMPANY",
    "LEAD_ID", "LOGO", "ORIGINATOR_ID", "ORIGIN_ID", "ORIGIN_VERSION", "REG_ADDRESS", "UTM_SOURCE", "UTM_MEDIUM", "UTM_CAMPAIGN", "UTM_CONTENT", "UTM_TERM", "WEB",
)
...
def test_company_add(bitrix_client: BaseClient, cache: Cache):
    ...
    company_id = bitrix_response.result
...
def test_company_get(bitrix_client: BaseClient, cache: Cache):
    ...
    company = bitrix_response.result
...
def test_company_list(bitrix_client: BaseClient, cache: Cache):
    ...
    companies = bitrix_response.result
