...
def test_crm_contact_fields(bitrix_client: BaseClient):
...
def test_crm_contact_add(bitrix_client: BaseClient, cache: Cache):
    ...
    contact_id = bitrix_response.result
...
def test_crm_contact_get(bitrix_client: BaseClient, cache: Cache):
    ...
    contact = bitrix_response.result
...
def test_crm_contact_list(bitrix_client: BaseClient, cache: Cache):
    ...
    contacts = bitrix_response.result
...
def test_crm_contact_list_as_list(bitrix_client: BaseClient):
    """"""
...
def test_crm_contact_list_as_list_fast(bitrix_client: BaseClient):
    """"""
